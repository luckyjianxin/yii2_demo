...
<html lang="en">
    ...
    <?php $this->beginBody() ?>
        ...
        <div class="content">
            ...
            <form class="login-form" action="<?=\yii\helpers\Url::toRoute('login/login')?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" name="LoginForm[password]" /> 
                </div>
        ...
        <div class="copyright"> <?=date('Y')?> &copy; Metronic. huanglongfei.cn. </div>
